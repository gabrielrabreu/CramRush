...
{
    public class ReplyQuizAttemptQuestionTests(
        ...
        : IClassFixture<CustomWebApplicationFactory>
    {
        ...
        public async Task ReturnsOkGivenExistingQuizAttempt()
        {
            ...
            var route = ReplyQuizAttemptQuestion.BuildRoute(existingQuizAttempt.Id);
            var request = new ReplyQuizAttemptQuestionRequest
            {
                QuestionId = existingQuizAttempt.Questions.First().Id,
                SelectedOptionId = existingQuizAttempt.Questions.First().Options.First().Id
            };
        ...
        {
            var route = ReplyQuizAttemptQuestion.BuildRoute(Guid.NewGuid());
            var request = new ReplyQuizAttemptQuestionRequest
            {
