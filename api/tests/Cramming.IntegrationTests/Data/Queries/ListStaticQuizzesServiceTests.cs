...
{
    public class ListStaticQuizzesServiceTests(EfTestFixture fixture) : IClassFixture<EfTestFixture>
    {
        private readonly EfRepository<StaticQuiz> repository = new(fixture.Db);
        private readonly ListStaticQuizzesService service = new(fixture.Db);
        ...
        public async Task ListQuizzesWithFirstPage()
        {
            ...
            await repository.AddAsync(new StaticQuiz("Sample Title 1"));
            await repository.AddAsync(new StaticQuiz("Sample Title 2"));
            await repository.AddAsync(new StaticQuiz("Sample Title 3"));
            await repository.AddAsync(new StaticQuiz("Sample Title 4"));
            await repository.AddAsync(new StaticQuiz("Sample Title 5"));
            await repository.AddAsync(new StaticQuiz("Sample Title 6"));
