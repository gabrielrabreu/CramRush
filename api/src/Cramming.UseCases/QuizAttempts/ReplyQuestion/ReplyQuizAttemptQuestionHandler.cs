namespace Cramming.UseCases.QuizAttempts.ReplyQuestion
{
    ...
    {
        public async Task<Result<ReplyQuizAttemptQuestionResultDto>> Handle(
            ReplyQuizAttemptQuestionCommand request,
            CancellationToken cancellationToken)
        {
            var attempt = await quizAttemptRepository.GetByIdAsync(
            ...
            await quizAttemptRepository.UpdateAsync(
                attempt,
                cancellationToken);
